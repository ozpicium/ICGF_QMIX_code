...
class RNN(nn.Module):
    ...
    # When the network is implemented for the platoon, the n_agents are reduced from 12 to 4.
    def __init__(self, input_shape, args):
        super(RNN, self).__init__()
        self.args = args
        # agent network, 可以参考论文里面的结构
        self.fc1 = nn.Linear(input_shape, args.rnn_hidden_dim)
        self.rnn = nn.GRUCell(args.rnn_hidden_dim, args.rnn_hidden_dim)  # GRU layer
